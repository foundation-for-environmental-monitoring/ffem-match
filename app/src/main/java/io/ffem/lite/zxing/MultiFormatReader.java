...
public final class MultiFormatReader implements Reader {
  ...
  @Override
  public FinderPatternInfo getPatterns(BinaryBitmap image, Map<DecodeHintType, ?> hints) throws NotFoundException {
    setHints(hints);
    return getPatterns(image);
  }
  ...
  private FinderPatternInfo getPatterns(BinaryBitmap image) throws NotFoundException {
    if (readers != null) {
      for (Reader reader : readers) {
        try {
          return reader.getPatterns(image, hints);
