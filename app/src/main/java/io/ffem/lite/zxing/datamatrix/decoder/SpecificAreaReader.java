 ...
 */
public final class SpecificAreaReader implements Reader {

    private final Reader delegate;

    public SpecificAreaReader(Reader delegate) {
...
//        int halfHeight = height / 2;
        ...
        try {
            ...
            Result result = delegate.decode(image.crop(width / 7, 0, width / 5, (int) (height / 3.5)), hints);
            makeAbsolute(result.getResultPoints(), width / 7, 0);
            return result;
