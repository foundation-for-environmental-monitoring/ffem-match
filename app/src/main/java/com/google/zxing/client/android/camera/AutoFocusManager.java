    ...
    private synchronized void autoFocusAgainLater() {
        if (!stopped && outstandingTask == null) {
            ...
            try {
                ...
                Timber.w(ree, "Could not request auto focus");
            }
        }
    }
        ...
        if (useAutoFocus) {
            ...
            if (!stopped && !focusing) {
                try {
                    ...
                    Timber.w(re, "Unexpected exception while focusing");
    ...
    synchronized void stop() {
        ...
        if (useAutoFocus) {
            ...
            try {
                ...
                // Have heard RuntimeException reported in Android 4.0.x+; continue?
                Timber.w(re, "Unexpected exception while cancelling focusing");
            }
        }
    }
