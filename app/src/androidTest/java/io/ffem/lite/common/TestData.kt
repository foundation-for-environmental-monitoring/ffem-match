...
val testDataList = mutableMapOf(
    ...
    9 to TestData(residualChlorine, expectedScanError = R.string.color_card_not_found),
    ...
    13 to TestData(residualChlorine, expectedScanError = R.string.color_card_not_found),
